...
public abstract class AbstractSpreadsheet
{
    ...
    /// This method performs a depth first search on the dependency graph associated
    /// with the spreadsheet. It adds every unique node seen the the changed list
    /// and uses the visited set in order to keep track on all nodes that have
    /// been seen
    ///
    /// If at any point the start is a dependent of a name a CircularExecption
    /// is thrown 
    ///   
    /// </summary>
